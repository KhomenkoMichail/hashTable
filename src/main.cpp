...
int main (void) {
    ...
    HASH_TABLE_CTOR(alwaysZero, 4007, alwaysZeroHash, &dump);
    ...
    HASH_TABLE_CTOR(firstLetterASCIICode, 4007, firstLetterASCIICodeHash, &dump);
    ...
    hashTable_t strlen = {};
    HASH_TABLE_CTOR(strlen, 4007, strlenHash, &dump);
    ...
    HASH_TABLE_CTOR(sumASCIIcodesSmall, 503, sumASCIIcodesHash, &dump);
    fillHashTable(&sumASCIIcodesSmall, "warAndPeace.txt");
    ...
    HASH_TABLE_CTOR(sumASCIIcodesBig, 4007, sumASCIIcodesHash, &dump);
    ...
    hashTable_t rol = {};
    HASH_TABLE_CTOR(rol, 4007, rolHash, &dump);
    ...
    hashTable_t ror = {};
    HASH_TABLE_CTOR(ror, 4007, rorHash, &dump);
    ...
    hashTable_t gnu = {};
    HASH_TABLE_CTOR(gnu, 4007, gnuHash, &dump);
    ...
    hashTable_t crc32 = {};
    HASH_TABLE_CTOR(crc32, 4007, crc32Hash, &dump);
